...
@section('title', 'Shortlisted Applications')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if($applications->count() > 0)
                        <table class="table table-striped table-bordered" id="shortlist-table">
                            <thead>
                                <tr>
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h4>No Shortlisted Applications</h4>
                            <p class="text-muted">There are no shortlisted applications at this time.</p>
                        </div>
                    @endif
                </div>
            </div>
